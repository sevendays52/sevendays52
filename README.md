...
![AR Foundation](https://img.shields.io/badge/AR_Foundation-FF6B6B?style=for-the-badge&logo=unity&logoColor=white)
...
**버추얼 스트리밍의 핵심은 '소통'이 아닌 'IP'입니다.**

### 📊 What I've Done
- 치지직/SOOP 플랫폼 시청자 데이터 수집 & 분석
- 국내외 버추얼 기업 리서치 (COVER, 패러블, 스콘)
- 버추얼 스트리머 시청자 페르소나 연구
